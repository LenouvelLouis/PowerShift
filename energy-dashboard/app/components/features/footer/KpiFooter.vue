      ...
      <div class="flex items-center gap-2 px-3 border-r border-[#1E293B]">
        ...
        <span class="flex items-center gap-1">
          <span
            ...
            :class="kpiStatus === 'converged' ? 'bg-emerald-400'
              : kpiStatus === 'error' || kpiStatus === 'non_converged' ? 'bg-red-500'
                : kpiStatus === 'running' ? 'bg-amber-400 animate-pulse'
                  : 'bg-gray-600'"
          />
          <span
            class="font-semibold transition-colors duration-300"
            :class="kpiStatus === 'converged' ? 'text-emerald-400'
              : kpiStatus === 'error' || kpiStatus === 'non_converged' ? 'text-red-400'
